...
vim.opt.inccommand = "split" -- live search
vim.opt.hlsearch = true      -- keep highlight afterwards (keybind later)
...
vim.keymap.set("n", "\\f", vim.diagnostic.goto_prev, { desc = "Go to previous [D]iagnostic message" })
vim.keymap.set("n", "\\d", vim.diagnostic.goto_next, { desc = "Go to next [D]iagnostic message" })
